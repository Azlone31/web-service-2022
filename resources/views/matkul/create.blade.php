    ...
    <div class="col-6">
        <div class="card">
            <div class="card-header alert-secondary">Tambah Data
                <a class="btn btn-sm btn-info float-right" href="{{ url('Soal') }}" style="color: white;">Kembali</a>
            </div>
            <div class="card-body">
                <form action="{{ route('Soal.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control mt-2" type="text" name="nama_mk"> 
                    </div>

                    <div class="form-group">
                        <label>Nama Dosen</label>
                        <input class="form-control mt-2" type="text" name="dosen">
                    </div>

                    <div class="form-group">
                        <label>Jumlah Soal</label>
                        <input class="form-control mt-2" type="text" name="jumlah_soal">
                    </div>
